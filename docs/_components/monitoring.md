...
A comprehensive observability solution that provides real-time monitoring, metrics collection, and alerting for all Graycat AI Server components.
...
- **Separately** for external monitoring of multiple Graycat deployments  
...
cd graycat-aiserver/monitoring
...
- Running Graycat AI Server instance
...
Use the Graycat Logs dashboard to:
...
The monitoring stack is designed to work alongside the main Graycat AI Server:
